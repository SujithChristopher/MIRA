...
csv_pth = r"C:\Users\CMC\Documents\openposelibs\pose\IMU_projects\imu_comparision"
...
class NanoIMUBLEClient(object):
    ...
    def __init__(self, uuid:str, csvout:bool=False) -> None:
        ...
        self.newdata = False
        self.printdata = True
        self.csv_file = open(csv_pth+"\\single_imu_ble5.csv", "w")
        self._csv = csv.writer(self.csv_file)
